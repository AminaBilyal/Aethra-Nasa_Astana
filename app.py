...
st.markdown(f"- **Most Polluted District:** {worst_district} → Improve air quality, traffic management, increase green spaces")
st.markdown(f"- **Best Practice District:** {best_district} → Study and replicate successful strategies")
